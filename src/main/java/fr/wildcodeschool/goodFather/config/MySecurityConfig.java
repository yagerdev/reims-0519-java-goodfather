...
public class MySecurityConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .antMatchers(HttpMethod.GET, "/categories/**", "/typologies/**", "/materials/**", "/works/**", "/users/**")
                .hasAuthority("ADMIN")
            .antMatchers(HttpMethod.POST, "/categories/**", "/typologies/**", "/materials/**", "/works/**", "/users/**")
                .hasAuthority("ADMIN")
            .antMatchers(HttpMethod.GET, "/tasks/**")
                .access("hasAuthority('ADMIN') or hasAuthority('PARTNER')")
            .antMatchers(HttpMethod.GET, "/tasks/**")
                .access("hasAuthority('ADMIN') or hasAuthority('PARTNER')")
            .antMatchers(HttpMethod.GET, "/projects/**", "/rooms/**", "/home/**", "/task/add")
                .access("hasAuthority('ADMIN') or hasAuthority('PARTNER') or hasAuthority('USER')")
