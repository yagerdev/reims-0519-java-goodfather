...
public class MySecurityConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .antMatchers(HttpMethod.POST, "/categories/**", "/typologies/**", "/materials/**", "/works/**", "/users/**").hasAuthority("ADMIN")
            .antMatchers(HttpMethod.GET, "/projects/**", "/rooms/**", "/home/**").access("hasAuthority('ADMIN') or hasAuthority('USER')")
            .antMatchers(HttpMethod.POST, "/projects/**", "/rooms/**", "/home/**", "/tasks/**").access("hasAuthority('ADMIN') or hasAuthority('USER')") 
